  ...
  return (
    <div className="mx-auto max-w-md pt-6">
      <div className="card text-center">
        <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-brand-pink/10 text-brand-pink">
          <CheckCircle2 className="h-8 w-8" />
        </div>
        <h1 className="mt-4 text-2xl font-black">応募を受け付けました</h1>
